...
/**
 * CodePlane spatial room configurations (§75).
 ...
 */
public class CodePlaneRooms {

    /** Room configuration for a CodePlane spatial room. */
    ...
    /** Activity event from a CodePlane room. */
    ...
    private static final List<RoomConfig> ROOMS = List.of(
        ...
        new RoomConfig("the-archive",
            ...
            "codeplane/archive.js",
            List.of("the-ledger"),
            Map.of("workspaceType", "documentation", "searchEnabled", "true"))
    );

    /** Get all CodePlane room configurations. */
