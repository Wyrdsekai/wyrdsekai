...
/**
 * CodeZaiku integration adapter (§75).
 * Maps CodeZaiku Board concepts to Wyrdsekai Room protocol.
 * CodeZaiku builds Wyrdsekai, Wyrdsekai runs CodeZaiku.
 *
 * Spatial mapping:
 *   CodeZaiku Board  → Wyrdsekai Room
 ...
 */
public class CodeZaikuAdapter {

    /** A CodeZaiku Board mapped to room metadata. */
    ...
    /** A CodeZaiku Card mapped to a room object. */
    ...
    /** A cross-project event bridging CodeZaiku and Wyrdsekai. */
    public record BridgeEvent(
        String source,     // "codezaiku" or "wyrdsekai"
    ...
    /** Spatial rooms corresponding to CodeZaiku workspaces (§75). */
    ...
    /**
     * Translate a CodeZaiku event to a Wyrdsekai room event.
     */
    public Optional<BridgeEvent> translateToRoom(String eventType, String sourceId,
                                                   Map<String, String> payload) {
        var event = new BridgeEvent("codezaiku", eventType, sourceId,
    ...
    /**
     * Translate a Wyrdsekai room event to a CodeZaiku event.
     */
    public Optional<BridgeEvent> translateToCodeZaiku(String eventType, String roomId,
                                                        Map<String, String> payload) {
    ...
    public String describe() {
        var sb = new StringBuilder("=== CodeZaiku Integration ===\n\n");
