...
#
# Downloads the latest release artifact from GitHub ($env:WYRDSEKAI_VERSION = '0.3.3'
...
if (-not $Version) {
    ...
    if (-not $Version) { Die "could not find the latest release. Set `$env:WYRDSEKAI_VERSION = '0.3.3' and re-run." }
}
Say "release $Version"
