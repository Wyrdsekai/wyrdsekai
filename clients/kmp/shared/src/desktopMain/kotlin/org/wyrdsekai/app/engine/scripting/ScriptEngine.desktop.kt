...
/**
 * Desktop ScriptEngine using Mozilla Rhino.
 *
 ...
 *
 * Desktop JVM supports Rhino JIT, but we keep optimizationLevel = -1
 * (interpreter) for consistency with Android and because room scripts
 * are lightweight enough that JIT is unnecessary.
 */
actual class ScriptEngine actual constructor(private val roomId: String) {
    ...
    private val rhinoContext: Context = Context.enter().apply {
        // Use interpreter mode for consistency with Android.
        // Room scripts are lightweight; JIT is unnecessary.
        optimizationLevel = -1
    }
