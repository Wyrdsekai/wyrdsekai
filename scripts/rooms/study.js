...
var SCROLL_GROUPS = [
  ...
  { id: "inference", title: "inference & models", keys: [
    ...
    ["WYRDSEKAI_INFERENCE_CONCURRENCY", "router-wide in-flight cap; unset = one slot per configured backend — raise for vLLM/SGLang", "(one per backend)"],
    ["WYRDSEKAI_BUNSHIN_TOKENS", "completion tokens a bunshin may spend by default; a reasoning model that thinks out loud needs more", "2000"],
    ["WYRDSEKAI_BUNSHIN_STEPS", "tool calls a bunshin may make by default", "30"],
    ["WYRDSEKAI_BUNSHIN_WALL_CLOCK", "seconds a bunshin may run by default; 0 = sized from measured inference latency", "0"],
