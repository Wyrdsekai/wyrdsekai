# Wyrdsekai — Universal Installer for Windows
#
# Usage:
#   irm https://wyrdsekai.dev/install.ps1 | iex
#   — or —
#   .\install.ps1           (from repo root — builds from source)
#
# Options:
#   -Version VERSION        Install a specific version
#   -Dir PATH               Install directory (default: %LOCALAPPDATA%\wyrdsekai)
#   -Port PORT              Default port (default: 7070)
#   -WithCodePlane          Also install CodePlane
